...
<head>
    ...
    <title>Process Deposit Request - WeBank Admin</title>
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <a href="deposit_requests.php" class="flex items-center space-x-2 text-white hover:text-red-100 transition duration-300">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                        </svg>
                        <span>Back to Deposit Requests</span>
                    </a>
                    <h1 class="text-2xl font-bold text-white ml-6">Process Deposit Request</h1>
                </div>
