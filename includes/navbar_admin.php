    ...
    <header class="bg-red-600 text-white shadow-lg no-print">
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
                <div class="flex items-center w-full md:w-auto justify-between md:justify-start">
                    <div class="flex items-center">
                        <?php if (basename($_SERVER['PHP_SELF']) !== 'dashboard.php'): ?>
                            <a href="dashboard.php" class="flex items-center space-x-2 text-white hover:text-red-100 transition duration-300 mr-4">
                        ...
                        <?php else: ?>
                            <a href="dashboard.php" class="text-2xl font-bold text-white">WeBank Admin</a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <div class="relative" id="settingsDropdown">
                        <button onclick="toggleDesktopDropdown()" class="bg-red-700 text-white px-4 py-2 rounded-lg hover:bg-red-800 transition duration-300 flex items-center space-x-2">
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 pt-4 border-t border-red-500">
                <div class="flex flex-col space-y-3">
                    <span class="text-red-100">Welcome, <?php echo htmlspecialchars($_SESSION['admin_name'] ?? $_SESSION['admin_username']); ?>!</span>
                    <a href="logout.php" class="text-white hover:text-red-100 flex items-center space-x-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                        </svg>
                        <span>Logout</span>
